...
export class YorutsukeStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    // ========================================
    // Parameter Store for Model Metadata (Pillar R: Observability)
    // ========================================
    ...
    new ssm.StringParameter(this, "AvailableBedrockModels", {
      ...
      tier: ssm.ParameterTier.STANDARD,
      description: "Available AWS Bedrock model IDs for dynamic model selection",
    });
    ...
    instantProcessLambda.addToRolePolicy(
      new iam.PolicyStatement({
        ...
        resources: [
          // Foundation models (direct invocation in us-east-1)
          "arn:aws:bedrock:*:*:foundation-model/*",
          // Inference profiles for multi-region routing
