...
| 功能 | 说明 | 状态 |
|------|------|------|
| 拖放图片 | Drag & drop 到应用窗口 | [x] |
| 点击选择 | 点击 Drop Zone 打开文件选择器 | [x] |
| 粘贴图片 | Ctrl+V / Cmd+V 粘贴剪贴板图片 | [x] |
| 图片压缩 | JPEG/PNG → WebP (<500KB) | [x] |
| 队列显示 | 显示 pending/compressed 状态 | [x] |
| 本地存储 | SQLite 存储图片元数据 | [x] |
| 重复检测 | MD5 去重 | [x] |
| 缩略图 | 显示压缩后预览 | [x] |
...
- [x] 拖放 10 张不同图片，全部压缩成功
- [x] 拖放重复图片，正确检测并跳过
- [x] 重启应用后，队列状态从 SQLite 恢复
- [x] 无网络环境下正常工作
- [x] 所有 SC-001~023 通过 (2026-01-07)
- [x] 所有 SC-500~503 通过 (2026-01-07)
- [x] 所有 SC-700~712 通过 (2026-01-07)
- [x] 所有 SC-1400, SC-1410~1412, SC-1420 通过 (2026-01-07)
